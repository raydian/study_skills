...
Read all six references before creating a project:
...
- `references/project-structure.md`: project files, implementation boundary, validation, and completion report.
...
- Load `$remotion-best-practices` before designing layouts or writing Remotion code. Also load its `rules/video-layout.md`, `rules/subtitles.md`, `rules/timing.md`, and `rules/transitions.md` references.
